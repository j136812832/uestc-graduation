...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='/media/ssd/zyj_data/vaismall/', help='data directory')
    ...
    parser.add_argument('--savedir', default="./ex/base/", help="directory to save the model snapshot")
    # parser.add_argument('--logFile', default= "log.txt", help = "storing the training and validation logs")
    parser.add_argument('--gpu', type=str, default="0", help="default GPU devices (1)")
