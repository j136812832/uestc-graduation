...
from part2_network import ZyjNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='../../igrass/zhangyijie/vaismall/', help='data directory')
    ...
    parser.add_argument('--savedir', default="./runs_part2_network_1102/", help="directory to save the model snapshot")
    # parser.add_argument('--logFile', default= "log.txt", help = "storing the training and validation logs")
    parser.add_argument('--gpu', type=str, default="0,1,2", help="default GPU devices (1)")

    args = parser.parse_args()

    print(int(args.gpu.split(',')[0]))
    run_id = '1'
